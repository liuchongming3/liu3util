package org.liu3.image.angle.qrcode;
...
public class Zxing {
    ...
    public static void main(String[] args) throws IOException, NotFoundException {
        ...
        File localFile = new File("C:\\Users\\EDZ\\Desktop\\2.jpg");
        String localQRcodeContent = parseImgFile(localFile);
...
//        System.out.println(url + " 二维码内容：" + netQRcodeContent);
    ...
    public static String parseImgFile(File file) throws IOException, NotFoundException {
    ...
    public static String parseImgUrl(URL url) throws IOException, NotFoundException {
        BufferedImage buffered = ImageIO.read(url);
        return parse(buffered);
    }
    private static String parse(BufferedImage bufferedImage) throws NotFoundException {
